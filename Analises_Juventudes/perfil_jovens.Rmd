...
g2 <- ggplot(dados2, aes(x=1,y=idade))+geom_boxplot(fill='#ffd42a')+labs(y="Idade", x="", title="Boxplots")+facet_wrap(~parte1)
g2
```
...
```{r}
tabela = table(agrupado$servico,agrupado$genero)
tabela = tabela[,-1]
knitr::kable(tabela)
```
