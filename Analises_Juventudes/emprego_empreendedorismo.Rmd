...
dados[,3][dados[,3] == 'Mobilizador Social 5 - Belo Horizonte / Jardim Felicidade'] = 'Consultor Emprego 5 - Ribeirão das Neves e Contagem / Florença e Nova Contagem'
```
...
corpus = Corpus(VectorSource(nao_contrat))
tdm <- TermDocumentMatrix(corpus)
