...
#freqEstadoCivil
print(freqEstadoCivil, digits = 2)
```
...
#freqIdade
print(freqInternetCasa, digits = 2)
```
...
#freqIdade
print(freqInternetCelular, digits = 2)
```
...
#freqIdade
print(freqChefesFamilia, digits = 2)
```
...
#freqIdade
print(freqGenChefesFamilia, digits = 2)
```
...
#freqIdade
print(freqParouVoltou, digits = 2)
```
...
#freqIdade
print(freqOrientacaoTrab, digits = 2)
```
...
#freqIdade
print(freqDiscriminado, digits = 2)
```
